...
const SECOES: Secao[] = [
  ...
  },
  {
    ...
    passos: [
      ...
      { titulo: 'Excluir item', texto: 'Cada item possui um botão "Excluir" abaixo do botão "Editar". Ao clicar, um modal de confirmação exibe o nome do item — confirme para excluir permanentemente. Essa ação é registrada no histórico do pedido.' },
      { titulo: 'Buscar itens no pedido', texto: 'No topo da lista de itens há um campo de busca que filtra em tempo real por descrição ou nome do fornecedor — útil para pedidos com muitos itens.' },
      { titulo: 'Itens tipo Tecido — envio ao fornecedor', texto: 'Ao criar ou editar um item com tipo "Tecido", aparece uma seção roxa com os campos "Data de envio" e "NF de envio". Preencha quando o tecido for enviado ao fornecedor. A data e NF de envio aparecem na linha do item na listagem do pedido.' },
