...
const SECOES: Secao[] = [
  ...
  },
  {
    ...
    passos: [
      { titulo: 'Cards de totais', texto: 'No topo da página aparecem os totais gerais do banco de dados: total de pedidos, total de entregas, total de ATs e total de ocorrências cadastrados.' },
      { titulo: 'Pedidos', texto: 'Duas tabelas: (1) Pedidos por mês — quantos pedidos foram criados e quantos foram entregues nos últimos 6 meses; (2) Pedidos por status — distribuição de todos os pedidos com percentual de participação.' },
      { titulo: 'Entregas', texto: 'Tabela dos últimos 6 meses com o número de entregas agendadas, realizadas e a taxa de conclusão de cada mês.' },
      { titulo: 'Prazos', texto: 'Três métricas: (1) Tempo médio de entrega em dias — calculado da data da venda até a data de entrega; (2) Pedidos entregues dentro do prazo prometido; (3) Pedidos entregues fora do prazo. Aparece apenas para pedidos que já foram entregues e têm data de venda registrada.' },
      { titulo: 'Profissionais', texto: 'Ranking de arquitetos e designers por volume de pedidos — mostra o total de pedidos e quantos foram entregues para cada profissional. Útil para identificar os parceiros que mais geram negócios.' },
      { titulo: 'ATs', texto: 'Distribuição das Assistências Técnicas por status (Aberta, Em reparo, No fornecedor, Resolvida etc.) com total e percentual.' },
      { titulo: 'ATs p/ Fornecedor', texto: 'Ranking dos fornecedores que geraram mais assistências técnicas — ajuda a identificar quais fornecedores têm mais problemas de qualidade.' },
      { titulo: 'Ocorrências', texto: 'Distribuição das ocorrências por tipo, com o total e quantas ainda estão abertas para cada categoria.' },
      { titulo: 'Tratamentos', texto: 'Quantos itens requerem cada tipo de tratamento especial: Içamento, Tecido a enviar, Retirada na loja, Higienização e Impermeabilização. Para cada tratamento mostra o total de itens e quantos já estão marcados como "Apto entrega".' },
    ...
    dicas: [
      ...
      'A análise de Prazos só considera pedidos com status "Entregue" — pedidos em andamento não entram no cálculo.',
      'A aba Profissionais é útil para calcular comissões ou avaliar o desempenho dos parceiros por período.',
      'A aba Tratamentos ajuda a dimensionar o volume de serviços especiais e acompanhar o que ainda está pendente.',
    ],
  },
  {
    id: 'historico',
