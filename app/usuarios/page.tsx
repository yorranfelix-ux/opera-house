        ...
        <div style={{ flex: 1, overflow: 'auto', padding: '20px 24px' }}>
          {loading ? (
            ...
            <div style={{ background: '#fff', borderRadius: '12px', border: '0.5px solid #e8e7e3', overflow: 'hidden' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 140px 200px 120px', padding: '8px 16px', background: '#f7f6f3', fontSize: '10px', fontWeight: '500', color: '#888', textTransform: 'uppercase', letterSpacing: '0.4px', gap: '12px' }}>
              ...
              {usuarios.map((u, i) => (
                <div key={u.id} style={{ display: 'grid', gridTemplateColumns: '1fr 140px 200px 120px', padding: '14px 16px', borderTop: '0.5px solid #f0efe9', alignItems: 'center', gap: '12px', background: i % 2 === 0 ? '#fff' : '#faf9f7' }}>
