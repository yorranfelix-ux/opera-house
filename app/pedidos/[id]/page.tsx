...
const STATUS_ITEM: Record<string, { label: string; bg: string; color: string }> = {
  ...
  aguardando_chegada: { label: 'Aguard. chegada', bg: '#FFF3CD', color: '#7A5800' },
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, overflow: 'auto', padding: '20px 24px' }}>
          ...
          <div style={{ background: '#fff', borderRadius: '12px', border: '0.5px solid #e8e7e3', overflow: 'hidden', marginBottom: '16px' }}>
            ...
            {itens.length > 0 && (
              <div>
                <div style={{ padding: '8px 16px', borderBottom: '0.5px solid #f0efe9' }}>
                  <input
                    type="text"
                    value={buscaItem}
                ...
                {itens.filter(item => {
                  ...
                  return item.descricao?.toLowerCase().includes(q) ||
